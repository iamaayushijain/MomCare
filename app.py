...
if 'logged_in' not in st.session_state or not st.session_state.logged_in:
    ...
    if selected == "Profile":
        ...
        weight = st.text_input("Weight (kg)", value=float(profile_data.get("weight", "")))  # Convert to str
        height = st.text_input("Height (cm)", value=float(profile_data.get("height", "")))  # Convert to str
